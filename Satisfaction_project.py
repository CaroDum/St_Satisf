...
image1 = Image.open('\\Projet DS\Images Streamlit\sourire client.jpg')
image2 = Image.open('\\Projet DS\Images Streamlit\customer satisfaction.jpg')
image3 = Image.open('\\Projet DS\Images Streamlit\WordCloud_neg.png')
image4 = Image.open('\\Projet DS\Images Streamlit\WordCloud_pos.png')
image5 = Image.open('\\Projet DS\Images Streamlit\métadonnées.PNG')
image6 = Image.open('\\Projet DS\Images Streamlit\df_info.PNG')
...
if choose == "Le sujet":
    ...
    if st.checkbox('Afficher les graphes relatifs aux valeurs de star :'):
        image9 = Image.open('\\Projet DS\Images Streamlit\graphes_star.PNG')
        st.image(image9)
    ...
    if st.checkbox('Afficher les stats descriptives sur star :'):
        image10 = Image.open("\\Projet DS\Images Streamlit\stats_star.JPG")
        st.image(image10)
    ...
    if st.checkbox("Afficher l'analyse sur la variable compagny :"):
        image11 = Image.open("\\Projet DS\Images Streamlit\graphes_company.png")
        st.image(image11)
    ...
    if st.checkbox("Afficher l'analyse sur la variable source :"):
        image12 = Image.open("\\Projet DS\Images Streamlit\graphes_source.png")
        st.image(image12)
    ...
    if st.checkbox("Afficher l'analyse :", key =1):
        image13 = Image.open('\\Projet DS\Images Streamlit\sourcerepart.JPG')
        st.image(image13)
    ...
    if st.checkbox("Afficher l'analyse :", key =2):
        image15 = Image.open("\\Projet DS\Images Streamlit\proportion_note_enseigne.png")
        st.image(image15)
    ...
    if st.checkbox("Afficher l'analyse :", key =3):
        image16 = Image.open("\\Projet DS\Images Streamlit\star_parenseigne.JPG")
        st.image(image16)
    ...
    if st.checkbox("Afficher l'analyse sur la réponse apportée:"):
        image17 = Image.open("C:\Projet DS\Images Streamlit\image17.png")
        st.image(image17)
    ...
    if st.checkbox("Afficher le graphe"):
        image18 = Image.open("C:\Projet DS\Images Streamlit\star_et_answer.png")
        st.image(image18)
...
############################################################################################
    ...
    if st.checkbox("en général, par enseigne et selon les notes données", key=1):
        image19 = Image.open("C:\Projet DS\Images Streamlit\long_com_describe.JPG")
        image20 = Image.open("C:\Projet DS\Images Streamlit\long_com_par_ens.JPG")
        image21 = Image.open("C:\Projet DS\Images Streamlit\long_com_par_star.JPG")
    ...
    if st.checkbox("en général, par enseigne et selon les notes données", key=2):
        image22 = Image.open("C:\Projet DS\Images Streamlit\mots_neg_describe.JPG")
        image23 = Image.open("C:\Projet DS\Images Streamlit\mots_neg_par_ens.JPG")
        image24 = Image.open("C:\Projet DS\Images Streamlit\mots_neg_par_star.JPG")
    ...
    if st.checkbox("en général, par enseigne et selon les notes données", key=3):
        st.write('\n ') 
        image25 = Image.open("C:\Projet DS\Images Streamlit\image25.JPG") #nb pts describe
        image26 = Image.open("C:\Projet DS\Images Streamlit\image26.JPG") #tc nb_pt / star
        ptsparstar = Image.open("C:\Projet DS\Images Streamlit\ptsparstar.JPG") #nb pts par star
        ptsparens = Image.open("C:\Projet DS\Images Streamlit\ptspar_ens.JPG") # nb pts par enseigne
...
#################################################################################
    ...
    if st.checkbox('Afficher la longueur des commentaires des clients contents" :'):
        st.write("Il y a 67576 mots dans l'ensemble des commentaires clients 'contents")
    if st.checkbox('Afficher la longueur des commentaires des clients mécontents" :'):
    ...
    # si le temps :
        # télécharger les 5 fichiers avec star / commentaire PROPRE
        # laisser le choix à l'auditeur de la note 
        # faire une nuage de mots correspondant à la note choisie
...
########################################################################
    ...
    image100 = Image.open("C:\Projet DS\Images Streamlit\etapes_modelisa.JPG")
    st.image(image100)
    st.write('\n')
    ...
    image101 = Image.open("C:\Projet DS\Images Streamlit\image101.JPG")
    st.image(image101)
...
########################################################################
    ...
    image200 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image200.JPG") #reg log ss m
    image201 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image201.JPG") #cm reg log ss m
    ...
    image202 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image202.JPG") #DTC ss m
    image203 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image203.JPG") #cm DTC ss m
    ...
    image204 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image204.JPG") #GBC ss m
    image205 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image205.JPG") #cm GBC ss m
    ...
    if st.checkbox('Afficher tableau récap + commentaires sur ces 3 modèles :', key = 1):
        image206 = Image.open("\\Projet DS\Images Streamlit\Modelisation\image206.JPG")  # resum_class_ssm
        st.image(image206)
...
## ----------------------------------------------##
    ...
    image210 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image210.JPG") #reg log av m
    image211 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image211.JPG") #cm reg log av m
    ...
    image212 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image212.JPG") #DTC av m
    image213 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image213.JPG") #cm DTC av m
    ...
    st.write("___3. Gradient Boosting Classifier sans métadonnées___ ")
    image214 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image214.JPG") #GBC av m
    image215 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image215.JPG") #cm GBC av m
    ...
    if st.checkbox('Afficher tableau récap + commentaires sur ces 3 modèles :', key = 2):
        image216 = Image.open("\\Projet DS\Images Streamlit\Modelisation\image216.JPG")  # resum_class_avm
        st.image(image216)
...
### --------------------------------------------------------------------- ###
    ...
    image220 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image220.JPG") #reg lin ss m
    image221 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image221.JPG") #cm reg lin ss m
    image227 = Image.open("C:\\Projet DS\Images Streamlit\image227.jpg")
    ...
    st.write("___2. Decision Tree Classifier sans métadonnées___ ")
    image222 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image222.JPG") #DTR ss m
    image223 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image223.JPG") #cm DTR ss m
    ...
    image224 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image224.JPG") #GBR ss m
    image225 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image225.JPG") #cm GBR ss m
    ...
    if st.checkbox('Afficher tableau récap + commentaires sur ces 3 modèles :', key = 3):
        image226 = Image.open("\\Projet DS\Images Streamlit\Modelisation\image226.JPG")  # resum_class_ssm
        st.image(image226)
...
## ----------------------------------------------##
    ...
    image230 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image230.JPG") #reg lin av m
    image231 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image231.JPG") #cm reg lin av m
    ...
    image232 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image232.JPG") #DTR av m
    image233 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image233.JPG") #cm DTR av m
    ...
    st.write("___3. Gradient Boosting Regressor sans métadonnées___ ")
    image234 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image234.JPG") #GBR av m
    image235 = Image.open("C:\Projet DS\Images Streamlit\Modelisation\image235.JPG") #cm GBR av m
    ...
    if st.checkbox('Afficher tableau récap + commentaires sur ces 3 modèles :', key = 4):
        image236 = Image.open("\\Projet DS\Images Streamlit\Modelisation\image236.JPG")  # resum_class_avm
        st.image(image236)
...
# Chargement du modèle (à faire sur l'app Streamlit)
    pipeLR = load("C:\Projet DS\Modeles\pipeLR.joblib") 
    pipeDT = load('C:\Projet DS\Modeles\pipeDT.joblib') 
...
# liste non exhaustive !#
  ...
  ## attention si le comm n'est pas rempli et le prob s'execute --> erreur sur parole
    ...
    if option == 'Régression Logisitique':
        mod = pipeLRM
...
#################################################################################    
    ...
    if st.checkbox('Afficher Top 40 Features pour le modèle Reg Log avec métadonnées'):
        image260 = Image.open("\\Projet DS\Images Streamlit\image260.JPG")
        st.image(image260) 
        st.write('\n')
    ...
    if st.checkbox('Afficher Importantes Features pour le modèle Gradient Boosting avec métadonnées'):
        image261 = Image.open("\\Projet DS\Images Streamlit\image261.JPG")
        image262 = Image.open("\\Projet DS\Images Streamlit\image 262.JPG")
...
#################################################################################    
    ...
    if st.checkbox('Prédictions sur un fichier "neuf" :'):
        ...
        image250 = Image.open("\\Projet DS\Images Streamlit\image250.JPG")
        image251 = Image.open("\\Projet DS\Images Streamlit\image251.JPG")
        st.write('\n ')
...
#################################################################################
    ...
    imagecd = Image.open("C:\Projet DS\Images Streamlit\photo CDU.PNG")
